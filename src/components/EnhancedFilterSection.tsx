...
export function EnhancedFilterSection({
  ...
  const allDevices: Device[] = [
    { id: "device-1", name: "Edificio Principal - Piso 1", location: "Edificio A", status: "active" },
    { id: "device-2", name: "Edificio Principal - Piso 2", location: "Edificio A", status: "active" },
    { id: "device-3", name: "Unidad de Manufactura 1", location: "Edificio B", status: "active" },
    { id: "device-4", name: "Unidad de Manufactura 2", location: "Edificio B", status: "warning" },
    { id: "device-5", name: "Bloque de Oficinas A", location: "Edificio C", status: "active" },
    { id: "device-6", name: "Bloque de Oficinas B", location: "Edificio C", status: "active" },
    { id: "device-7", name: "Línea de Producción A", location: "Edificio B", status: "active" },
    { id: "device-8", name: "Línea de Producción B", location: "Edificio B", status: "active" },
    { id: "device-9", name: "Unidad de Ensamblaje 1", location: "Edificio D", status: "active" },
    { id: "device-10", name: "Unidad de Ensamblaje 2", location: "Edificio D", status: "inactive" },
  ];

  // Virtual groups with associated devices
  const virtualGroups = {
    "group-production": {
      name: "Grupo de Producción",
  ...
  const timePerl = [
    ...
    { id: "last-7-days", name: "Últimos 7 Días" },
    { id: "last-30-days", name: "Últimos 30 Días" },
  ];
      ...
      <CardContent className="p-5">
        <div className="flex flex-col lg:flex-row gap-4 items-end">
          ...
          <div className="flex-1 space-y-2">
            <label className="text-sm font-medium text-muted-foreground">Tipo de Filtro</label>
            <Select 
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="virtual-group">Grupo Virtual</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="flex-1 space-y-2">
            <label className="text-sm font-medium text-muted-foreground">
              {selectedFilterType === "device" ? "Seleccionar Dispositivo" : "Seleccionar Grupo Virtual y Dispositivos"}
            </label>
            ...
            {selectedFilterType === "device" ? (
              ...
              >
                <SelectTrigger className="h-11 border-border/50 bg-background/50">
                  <SelectValue placeholder="Elegir grupo virtual">
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <Badge variant="outline" className="text-xs">
                            {group.devices.length} dispositivos
                          </Badge>
                        </div>
                      </SelectItem>
          ...
          {/* Data Mode */}
          <div className="flex-1 space-y-2">
            <label className="text-sm font-medium text-muted-foreground">Modo de Datos</label>
          ...
          {/* Time Period */}
          <div className="flex-1 space-y-2">
            <label className="text-sm font-medium text-muted-foreground">Período de Tiempo</label>
